...
<div style="display:grid; grid-template-columns: 1fr 340px; gap:20px; align-items:start;">
    ...
    <div>
        ...
        <div style="display:flex; flex-direction:column; gap:10px;">
            ...
            <form action="<?php echo e(route('data-kejadian.destroy', $kejadian->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.sigap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sigap\resources\views/data-kejadian-detail.blade.php ENDPATH**/ ?>