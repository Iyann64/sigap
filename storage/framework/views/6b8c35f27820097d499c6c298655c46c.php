...
<div class="card" id="aktivitas-user">
    ...
    <?php if($activityLogs->hasPages()): ?>
        ...
        <div class="pagination-dashboard">
            ...
            <?php else: ?>
                <a href="<?php echo e($activityLogs->previousPageUrl()); ?>#aktivitas-user">
                    &lt;
                </a>
            <?php endif; ?>
            ...
            <?php for($page = 1; $page <= $activityLogs->lastPage(); $page++): ?>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e($activityLogs->url($page)); ?>#aktivitas-user">
                        <?php echo e($page); ?>
            ...
            <?php if($activityLogs->hasMorePages()): ?>
                <a href="<?php echo e($activityLogs->nextPageUrl()); ?>#aktivitas-user">
                    &gt;
                </a>
            <?php else: ?>
                <span class="disabled">&gt;</span>
